...
`
  ...
  },
  {
    ...
    "answer": `1. 새 노드 생성:삽입할 노드를 메모리에 할당하고 데이터 값을 저장합니다.
                2. 삽입 위치 찾기: 삽입할 노드를 리스트의 어느 위치에 넣을지를 결정하고 해당 위치 직전 노드를 찾습니다.
                3. 새 노드의 링크 설정: 새 노드의 링크 필드를 삽입 위치의 이전 노드와 다음 노드를 가리키도록 설정합니다.
                4. 기존 노드의 링크 수정: 삽입 위치 이전 노드의 링크 필드를 새 노드를 가리키도록 수정합니다.
                5. 새 노드를 리스트에 연결: 새 노드를 리스트에 연결하여 삽입을 완료합니다.`
  },
  {
    "chapter": "8장",
