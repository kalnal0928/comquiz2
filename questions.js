const questions = [
  ...
  {
    "chapter": "5장",
    "question": "5장-5. 의사코드 언어의 설계 원칙에 해당하지 않는 것은? p16",
...
`
  ...
  },
  {
    ...
    "answer": ` 함수의 헤더는 함수이름, 세부사항 정의
              AI정리
              1. 함수명(Function Name): 함수를 식별하고 호출할 때 사용하는 이름
              2. 반환 타입(Return Type): 함수가 실행 후 돌려주는 값의 데이터 타입
                                        void인 경우 값을 반환하지 않음
              3. 매개변수 목록(Parameter List): 함수가 받아들이는 입력값들의 타입과 이름
                                                매개변수의 개수, 순서, 타입을 명시
              4. 함수 시그니처(Function Signature): 함수의 고유한 식별자 역할, 오버로딩 시 구분 기준`
  },
  {
    "chapter": "6장",
  ...
  {
    "chapter": "6장",
    "question": "6장-20. '생성자'에 대한 설명으로 틀린 것은?슬라이드 27쪽(53)",
  ...
  },
  {
    ...
    "answer": `AI개요
              ...
              3. 기존 노드 링크 설정: 삽입할 위치의 이전 노드의 다음 포인터를 새 노드를 가리키도록 설정
              `
  },
  {
    "chapter": "8장",
